...
const SUPPORT_TOUCH = true; // ('ontouchstart' in window);
const SUPPORT_POINTER_EVENTS = false; // prefixed(window, 'PointerEvent') !== undefined;
const SUPPORT_ONLY_TOUCH = true; // SUPPORT_TOUCH && MOBILE_REGEX.test(navigator.userAgent);
